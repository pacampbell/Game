...
public class Vector3_Old
{
    ...
    public Vector3_Old(float x, float y, float z)
    {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public Vector3_Old(float value)
    {
        this.x = value;
        this.y = value;
        this.z = value;
    ...
    // and a 3rd point z
    public Vector3_Old(Vector2 vec2, float z)
    {
        this.x = vec2.x;
        this.y = vec2.y;
        this.z = z;
     ...
     * @return Vector3
     */
    public static Vector3_Old add(Vector3_Old veca, Vector3_Old vecb)
    {
        float vecCx = veca.x + vecb.x;
        float vecCy = veca.y + vecb.y;
        float vecCz = veca.z + vecb.z;
        return new Vector3_Old(vecCx, vecCy, vecCz);
    }
     ...
     * @return Vector2
     */
    public static Vector3_Old clamp(Vector3_Old vec, Vector3_Old min, Vector3_Old max)
    {
     ...
     * @return
     */
    public static Vector3_Old crossProduct(Vector3_Old u, Vector3_Old v)
    {
        float newX = (u.y * v.z) - (u.z * v.y);
        float newY = (u.z * v.x) - (u.x * v.z);
        float newZ = (u.x * v.y) - (u.y * v.x);
        return new Vector3_Old(newX, newY, newZ);
    }
     ...
     * @return float
     */
    public static float distance(Vector3_Old veca, Vector3_Old vecb)
    {
     ...
     * @return float
     */
    public static float distanceSquared(Vector3_Old veca, Vector3_Old vecb)
    {
        float magA = magnitude(veca);
        float magB = magnitude(vecb);
     ...
     * @return float
     */
    public static float dotProduct(Vector3_Old veca, Vector3_Old vecb)
    {
     ...
     * @return result
     */
    public boolean equals(Vector3_Old vecb)
    {
     ...
     * @return result
     */
    public static boolean equals(Vector3_Old veca, Vector3_Old vecb)
    {
        boolean result = false;
        float magA = magnitude(veca);
        float magB = magnitude(vecb);
     ...
     * @return float magnitude
     */
    public static float magnitude(Vector3_Old vec)
    {
     ...
     * @return float magnitudeSquared
     */
    public static float magnitudeSquared(Vector3_Old veca)
    {
     ...
     * @return Vector3
     */
    public static Vector3_Old max(Vector3_Old veca, Vector3_Old vecb)
    {
        ...
        return new Vector3_Old(cx, cy, cz);
    }
     ...
     * @return Vector3
     */
    public static Vector3_Old min(Vector3_Old veca, Vector3_Old vecb)
    {
        float cx; // VectorC x value
        float cy; // VectorC y value
        float cz; // VectorC z value
     ...
     * @return Vector3
     */
    public static Vector3_Old negate(Vector3_Old veca)
    {
        return new Vector3_Old(veca.x * -1, veca.y * -1, veca.z * -1);
    }
     ...
     * @return
     */
    public static Vector3_Old one()
    {
        return new Vector3_Old(1.0f, 1.0f, 1.0f);
    }
     ...
     * @return Vector2
     */
    public static Vector3_Old reflect(Vector3_Old incident, Vector3_Old normal)
    {
        float dotResult = dotProduct(incident, normal);
        float dot2 =  dotResult * 2;
        Vector3_Old normDot2 = scalarMultiply(normal, dot2);
     ...
     * @return Vector3
     */
    public static Vector3_Old scalarMultiply(Vector3_Old veca, float scalar)
    {
     ...
     * @param scalar
     */
    public static Vector3_Old scalarMultiply(Vector3_Old veca, int scalar)
    {
     ...
     * @return
     */
    public static Vector3_Old subtract(Vector3_Old veca, Vector3_Old vecb)
    {
        float vecCx = veca.x - vecb.x;
        float vecCy = veca.y - vecb.y;
        float vecCz = veca.z - vecb.z;
     ...
     * @return Vector3
     */
    public static Vector3_Old unitX()
    {
        return new Vector3_Old(1.0f, 0.0f, 0.0f);
    }
     ...
     * @return Vector3
     */
    public static Vector3_Old unitY()
    {
        return new Vector3_Old(0.0f, 1.0f, 0.0f);
    }
     ...
     * @return Vector3
     */
    public static Vector3_Old unitZ()
    {
        return new Vector3_Old(0.0f, 0.0f, 1.0f);
    }
     ...
     * @return Vector3
     */
    public static Vector3_Old zero()
    {
        return new Vector3_Old();
    }
